    ...
    execute: () =>
      sql`
        SELECT
          ...
          sent_by_thread_id AS "sentByThreadId",
            ...
            Effect.gen(function* () {
              ...
              for (const row of messageRows) {
                ...
                threadMessages.push({
                  ...
                  sentByThreadId: row.sentByThreadId ?? null,
                  turnId: row.turnId,
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                spawnedByThreadId: row.spawnedByThreadId ?? null,
                controller: row.controller ?? "human",
                controlChangedAt: row.controlChangedAt ?? null,
                assistantRole: row.assistantRole ?? null,
                deletedAt: row.deletedAt,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        spawnedByThreadId: threadRow.value.spawnedByThreadId ?? null,
        controller: threadRow.value.controller ?? "human",
        controlChangedAt: threadRow.value.controlChangedAt ?? null,
        assistantRole: threadRow.value.assistantRole ?? null,
