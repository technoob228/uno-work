...
/** Same SIGTERM → SIGKILL deadline as Hermes / Cursor (one implementation in AcpSessionRuntime). */
export const CUSTOM_HARNESS_FORCE_KILL_AFTER_MS = ACP_HARNESS_FORCE_KILL_AFTER_MS;
