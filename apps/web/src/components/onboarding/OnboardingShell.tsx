...
export function OnboardingShell({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-background text-foreground">
      <header className="drag-region flex h-14 shrink-0 items-center gap-3 border-b border-border pl-[78px] pr-5 fullscreen:pl-5 wco:pl-[calc(env(titlebar-area-x)+1em)]">
