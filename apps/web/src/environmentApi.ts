...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    skills: {
      status: rpcClient.skills.status,
      install: rpcClient.skills.install,
      remove: rpcClient.skills.remove,
    },
    filesystem: {
    ...
    unoComputer: {
      ...
      activity: (input) => rpcClient.unoComputer.activity(input),
      ...
      openApp: rpcClient.unoComputer.openApp,
      appAccess: rpcClient.unoComputer.appAccess,
      ...
      boost: rpcClient.unoComputer.boost,
      endBoost: (input) => rpcClient.unoComputer.endBoost(input),
      embedCheck: rpcClient.unoComputer.embedCheck,
      resources: () => rpcClient.unoComputer.resources(),
      diskUsage: rpcClient.unoComputer.diskUsage,
      diskClean: rpcClient.unoComputer.diskClean,
      resourceAction: rpcClient.unoComputer.resourceAction,
    },
