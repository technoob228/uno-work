...
> From [getsentry/skills](https://github.com/getsentry/skills) (`security-review`), Apache-2.0 — see LICENSE. Renamed to avoid clashing with the built-in `/security-review`.
