...
export const ManagerTokenId = makeEntityId("ManagerTokenId");
export type ManagerTokenId = typeof ManagerTokenId.Type;
export const ManagerProposalId = makeEntityId("ManagerProposalId");
export type ManagerProposalId = typeof ManagerProposalId.Type;
